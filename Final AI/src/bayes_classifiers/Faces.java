...
public class Faces {
	...
	static int splitRows = 10;
	static int splitColumns = 10;
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		pyNotFace = 1 - pyFace;
		//System.out.println("Face" + pyFace);
		//System.out.println("Not Face " + pyNotFace);
		/*
		 * for(int i = 0; i < feature.size(); i++) { printFeatures(i);
		 * System.out.println(); }
		 */
		...
		for(int i = 0; i < feature.size(); i++) {
			...
			for(int j = 0; j < feature.get(i).size();j++) {
				...
				double answer1 = totalCount[j][feature.get(i).get(j)];
				
				multiF *= answer1;
				//System.out.println("here" + multiF);
				
				double answer2 = totalCount2[j][feature.get(i).get(j)];
